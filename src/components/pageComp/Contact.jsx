...
export default function Contact() {
  ...
  return (
    <main>
      <div className="untree_co-section contact">
        <div className="container">
          <div className="block">
            <div className="row justify-content-center">
              <div className="col-md-8 col-lg-8 pb-4">

                <div className={`row mb-5 animate__animated_scroll ${firstScrollEvent ? 'fadeInRight' : ''}`}>
                  {infoItems.map((item, index) => (
                    <div className="bundle col-lg-4" key={index}>
                      <div className="service no-shadow align-items-center link horizontal d-flex active"
                        ...
                        <div className="service-contents">
                          <p>{item.content}{String(item.event)}</p>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="contact_input_group">
                  <div className="row mb-5 name_and_call">
                    <div className="col-6">
                      <div className="form-group">
                        <label className="text-black" htmlFor="fname">성함</label>
                        <input type="text" className="form-control mobile_v" id="fname" />
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="form-group">
